...
the OpenProject plugin will provide its own commit message issue key validator. 
This can be configured right on the commit message validation config.

# Validator config
The OpenProject Issue Key Validator checks each commit for valid issue keys.
